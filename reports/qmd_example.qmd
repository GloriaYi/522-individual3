...
![](../results/horse_pops_plot.png){#fig-horse-pop width=60%}
...
```{python}
#| label: tbl-horse-sd
#| tbl-cap: Standard deviations of horse populations by province (1906–1972).
...
![](../results/horse_pops_plot_largest_sd.png){#fig-horse-largest width=70%}
